...
%                    alpha  a   theta   d
links(1) = link([    pi/2   0   0       0   ], 'standard');
links(2) = link([    0     L1   0       0   ], 'standard');
links(3) = link([    0    -L2   0       0   ], 'standard');

% now create a robot to represent a single leg
leg = robot(links, 'name', 'leg', 'offset', [pi/2   0  -pi/2]);
...
legs(1) = robot(leg, 'name', 'leg1');
legs(2) = robot(leg, 'name', 'leg2', 'base', transl(-L, 0, 0));
legs(3) = robot(leg, 'name', 'leg3', 'base', transl(-L, -W, 0)*trotz(pi));
legs(4) = robot(leg, 'name', 'leg4', 'base', transl(0, -W, 0)*trotz(pi));
