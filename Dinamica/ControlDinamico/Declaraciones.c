...
*/
 ...
 Ti[0]=2*0.2; Td[0]=(0.2*0.2)/(0.2*2);   Kp[0]=40444*Ti[0];
 Ti[1]=2*0.2; Td[1]=(0.2*0.2)/(0.2*2);   Kp[1]=63451*Ti[1]; 
 Ti[2]=2*0.2; Td[2]=(0.2*0.2)/(0.2*2);   Kp[2]=10775*Ti[2];   
...
*/
 ...
 /* PID Robot Real SR */
/*
 Ti[0]=2*0.19;  Td[0]=(0.19*0.19)/(0.19*2);   Kp[0]=39521*Ti[0];
 Ti[1]=2*0.2;   Td[1]=(0.2*0.2)/(0.2*2);     Kp[1]=69071*Ti[1]; 
 Ti[2]=2*0.19;  Td[2]=(0.19*0.19)/(0.19*2);   Kp[2]=21703*Ti[2]; 
*/
 ...
 */
  ...
  /*
  Ti[0]=0.3800; Td[0]=0.0950; Kp[0]=1185.6*Ti[0];
