...
subplot(334);plot(t_D,qdi_D_mod(:,1));title('Velocidad Modelo'); grid; subplot(335);plot(t_D,qdi_D_mod(:,2));grid;subplot(336);plot(t_D,qdi_D_mod(:,3));grid;
subplot(337);plot(t_D,qddi_D_mod(:,1));title('Aceleracion Modelo'); grid; subplot(338);plot(t_D,qddi_D_mod(:,2));grid;subplot(339);plot(t_D,qddi_D_mod(:,3));grid;
...
subplot(334);plot(t_D,qdi_D_mod(:,1)-qd_est(:,1));title('Error Velocidad'); grid; subplot(335);plot(t_D,qdi_D_mod(:,2)-qd_est(:,2));grid;subplot(336);plot(t_D,qdi_D_mod(:,3)-qd_est(:,3));grid;
subplot(337);plot(t_D,qddi_D_mod(:,1)-qdd_est(:,1));title('Error Aceleracion'); grid; subplot(338);plot(t_D,qddi_D_mod(:,2)-qdd_est(:,2));grid;subplot(339);plot(t_D,qddi_D_mod(:,3)-qdd_est(:,3));grid;
